...
\begin{align*}
\E[\exp(\lambda(X-\mu))]&=\E\left\{\sum\limits_{i=0}^{\infty}\frac{f^{(i)}(0)}{i!}\lambda(X-\mu)^i\right\}=\sum\limits_{i=0}^{\infty}\E\left\{\frac{f^{(i)}(0)}{i!}\lambda(X-\mu)^i\right\}\\
&=1+\lambda\E[(X-\mu)]+\frac{\lambda^2\E[(X-\mu)]^2}{2}+\sum\limits_{i=3}^{\infty}\frac{\lambda^k\E[(X-\mu)^k]}{k!}\\
&=1+\frac{\lambda^2\sigma^2}{2}+\sum\limits_{i=3}^{\infty}\frac{\lambda^k\E[(X-\mu)^k]}{k!}
\end{align*}
\end{frame}
